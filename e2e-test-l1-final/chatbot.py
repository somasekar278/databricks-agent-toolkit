...
def collect_assessment() -> Optional[dict]:
    ...
    """
    print("\n" + "="*50)
    print("📊 Quick Feedback (helps improve the bot)")
    print("="*50)
...
async def main():
    print("🤖 e2e-test-l1-final (Chatbot)")
    print(f"Mode: {'Streaming' if ENABLE_STREAMING else 'Batch'}")
    print("Type 'quit' to exit\n")
    
    # Set up MLflow tracking
    mlflow.set_tracking_uri("databricks")
    experiment_path = config.get("mlflow", {}).get("experiment", "/Shared/e2e-test-l1-final")
