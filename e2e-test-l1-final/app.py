"""
e2e-test-l1-final - Chatbot Web App
...
experiment = config.get("mlflow", {}).get("experiment", "/Shared/e2e-test-l1-final")
try:
...
def home():
    ...
    return render_template_string(
        CHAT_HTML,
        name=config.get("agent_name", "e2e-test-l1-final"),
...
def chat():
    ...
    try:
        ...
        # Call LLM (traced automatically by @mlflow.trace)
        import asyncio
...
if __name__ == '__main__':
    print(f"🚀 Starting e2e-test-l1-final on port {PORT}", flush=True)
