# 🚀 Deployment Guide - Agent Framework

**Complete guide to deploying agent solutions built with Agent Framework.**
...
```
Your Agent Solution
├── Agent Code (your custom agents)
├── Configuration (YAML configs)
├── Dependencies (framework + your deps)
...
├── Dockerfile          # Generated by framework
    ...
    tasks=[
        {
            ...
            "libraries": [
                {"pypi": {"package": "agent-framework[all]"}},
...
workflow = w.jobs.create(
    ...
    tasks=[
        ...
        jobs.Task(
            ...
            libraries=[
                jobs.Library(pypi=jobs.PythonPyPiLibrary(package="agent-framework[databricks]")),
  ...
  executeAgent:
    ...
    events:
      - http:
          ...
          method: post
    layers:
      - arn:aws:lambda:us-west-2:123456789:layer:agent-framework:1
...
**Ready to deploy?** Choose your deployment option above and follow the guide! 🚀
