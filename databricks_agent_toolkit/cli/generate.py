...
For more info: https://databricks-agent-toolkit.readthedocs.io
    ...
    parser.add_argument(
        "name",
        help="Agent name (e.g., 'customer-support', 'research-agent')"
    )
    ...
    parser.add_argument(
        ...
        help="Model endpoint (default: databricks-claude-sonnet-4-5)"
    )
    ...
    parser.add_argument(
        "--enable-mcp",
        action="store_true",
        help="Enable MCP tools (api, workflow, system)"
    )
    parser.add_argument(
        "--enable-optimization",
        action="store_true",
        help="Enable automatic optimization (workflow, system)"
    )
    parser.add_argument(
        "--enable-memory",
        action="store_true",
        default=True,
        help="Enable memory (assistant+, enabled by default)"
    )
    parser.add_argument(
        "--enable-a2a",
        action="store_true",
    ...
    parser.add_argument(
        "--agents",
        help="Comma-separated list of agent names for system (e.g., 'agent_a,agent_b,agent_c')"
    )
    ...
    parser.add_argument(
        "--list",
        action="store_true",
        help="List available scaffold levels"
    )
